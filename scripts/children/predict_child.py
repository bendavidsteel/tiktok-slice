...
from train_classifier import StackingEnsembleClassifier
...
def main():
    ...
    video_df.select(['child_prob', 'id', 'locationCreated', 'createTime']).write_parquet(os.path.join(dir_path, 'video_child_prob.parquet.gzip'))
