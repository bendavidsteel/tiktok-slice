...
EMOJI_REGEX = re.compile(EMOJI_SEQUENCE)

def is_all_emojis(s):
    return re.match(rf"{EMOJI_SEQUENCE}+\s*", s) is not None
...
def main():
    ...
    comment_df = comment_df.with_columns(pl.col('text').map_elements(is_all_emojis, pl.Boolean).alias('is_all_emojis'))
    pass
